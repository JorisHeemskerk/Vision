...
# normalEdges1 = filters.sobel(img_rescale)
# normalEdges2 = feature.canny(img, sigma=0)
# filterImg = color.rgb2gray(img_rescale)
# filterEdges1 = filters.sobel(img_rescale)
# filterEdges2 = feature.canny(img_rescale, sigma=0)
...
# ax1.axis('off')
# ax1.set_title(r'Sobel filter', fontsize=20)

# ax2.imshow(normalEdges2, cmap=plt.cm.gray)
# ax2.axis('off')
# ax2.set_title(r'Canny filter, $\sigma=1.5$', fontsize=20)
...
# ax4.axis('off')
# ax4.set_title(r'Sobel filter', fontsize=20)

# ax5.imshow(filterEdges2, cmap=plt.cm.gray)
# ax5.axis('off')
# ax5.set_title(r'Canny filter, $\sigma=1.5$', fontsize=20)
